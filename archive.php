			...
			<?php endif; ?>
				...
				<div id="primary" class="content-area">
					...
					if ( have_posts() ) : ?>
						<div class="mt-5">
							<?php
								the_archive_title( '<h4 class="card-title text-primary"><strong>', '</strong></h4>' );
						...
						the_posts_navigation( array(
							'next_text' => esc_html__( 'Newer Posts', 'space-material' ),
							'prev_text' => esc_html__( 'Older Posts', 'space-material' ),
						) );
