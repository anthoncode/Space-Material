...
<div class="mt-5">
	<div class="container">
		...
		<div class="row">
			...
			<?php else : ?>
				<div class="col-md-8 col-sm-12 wp-bp-content-width">
			<?php endif; ?>
				<div id="primary" class="content-area">
					...
					if ( have_posts() ) :
						...
						echo '<div class="row single-post mb-4"> ';
						/* Start the Loop */
						...
						the_posts_pagination(
							array(
								'prev_text' => '<i class="fa fa-chevron-left"></i> ' . __( 'Newer posts', 'space-material' ),
								'next_text' => __( 'Older posts', 'space-material' ) . ' <i class="fa fa-chevron-right"></i>',
							)
						);
			...
			<?php if ( $default_sidebar_position != 'no' ) : ?>
				<?php if ( $default_sidebar_position === 'right' ) : ?>
					<div class="col-md-4 col-sm-12 wp-bp-sidebar-width">
				<?php elseif ( $default_sidebar_position === 'left' ) : ?>
					<div class="col-md-4 col-sm-12 order-md-first wp-bp-sidebar-width">
				<?php endif; ?>
						<?php get_sidebar(); ?>
					</div><!-- /.col-md-4 -->
			<?php endif; ?>
