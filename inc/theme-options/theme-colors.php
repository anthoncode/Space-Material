...
if( class_exists( 'Kirki' ) ) {
    function space_material_colors_section( $wp_customize ) {
        $wp_customize->get_control( 'background_color' )->label = esc_html__( 'Body Background Color', 'space-material' );
        $wp_customize->get_section( 'colors' )->title = esc_html__( 'Theme Colors', 'space-material' );
    }
    add_action( 'customize_register', 'space_material_colors_section' );
}

space_material_Kirki::add_field( 'space_material_theme', array(
	'settings' => 'styling_header_bg_color',
	'label'    => esc_html__( 'Header Background Color', 'space-material' ),
	'section'  => 'colors',
	'type'     => 'color',
    /*'default'  => '#f8f9fa',*/
    'output'   => array(
...
space_material_Kirki::add_field( 'space_material_theme', array(
	...
	'section'  => 'colors',
	'type'     => 'color',
    'label' => esc_html__( 'Links & Buttons Color', 'space-material' ),
    'default'  => '#007bff',
    'output'   => array(
        array(
...
space_material_Kirki::add_field( 'space_material_theme', array(
	...
	'label'    => esc_html__( 'Links & Buttons Hover Color', 'space-material' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#0069d9',
    'output'   => array(
...
space_material_Kirki::add_field( 'space_material_theme', array(
	...
	'label'    => esc_html__( 'Footer Background Color', 'space-material' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#1b2c51',
    'output'   => array(
...
space_material_Kirki::add_field( 'space_material_theme', array(
	...
	'label'    => esc_html__( 'Footer Text Color', 'space-material' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#6c757d',
    'output'   => array(
...
space_material_Kirki::add_field( 'space_material_theme', array(
	...
	'label'    => esc_html__( 'Footer Link Color', 'space-material' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#007bff',
    'output'   => array(
