                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <?php echo esc_html( space_material_get_short_excerpt( 20, $featured_page_1 ) ); ?>
                                </p>
                                <a href="<?php echo esc_url( get_post_permalink( $featured_page_1 ) ); ?>" class="btn btn-primary"><?php esc_html_e( 'Read More', 'space-material' ); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <?php echo esc_html( space_material_get_short_excerpt( 20, $featured_page_2 ) ); ?>
                                </p>
                                <a href="<?php echo esc_url( get_post_permalink( $featured_page_2 ) ); ?>" class="btn btn-primary"><?php esc_html_e( 'Read More', 'space-material' ); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <?php echo esc_html( space_material_get_short_excerpt( 20, $featured_page_3 ) ); ?>
                                </p>
                                <a href="<?php echo esc_url( get_post_permalink( $featured_page_3 ) ); ?>" class="btn btn-primary"><?php esc_html_e( 'Read More', 'space-material' ); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
